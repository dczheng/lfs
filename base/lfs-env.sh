...
export LFS_CROSS_TOOLCHAIN_BUILD_DIR=$BUILD_ROOT_DIR/toolchain
echo "LFS_CROSS_TOOLCHAIN_BUILD_DIR: "$LFS_CROSS_TOOLCHAIN_BUILD_DIR

export LFS_TEMPORARY_TOOLS_BUILD_DIR=$BUILD_ROOT_DIR/temporary-tools
echo "LFS_TEMPORARY_TOOLS_BUILD_DIR: "$LFS_TEMPORARY_TOOLS_BUILD_DIR
